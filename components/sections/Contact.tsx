            ...
            <div className="space-y-10">
              ...
              <form className="space-y-6 mt-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2 mt-1 rounded-md border border-gray-300 focus:ring-2 focus:ring-green-500 focus:outline-none text-sm"
                    />
                  </div>
                  <div>
                    <label
                ...
                >
                  <button
                    type="submit"
                    className="w-full bg-green-700 hover:bg-green-800 text-white font-semibold p-2 rounded-md transition-colors"
                  >
                    Send Message
                  </button>
                </motion.div>
